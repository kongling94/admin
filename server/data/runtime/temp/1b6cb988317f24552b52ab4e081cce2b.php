<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"themes/admin_simpleboot3/portal/admin_article/add.html";i:1541671360;s:74:"/var/www/app_manage/api/public/themes/admin_simpleboot3/public/header.html";i:1541671360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <link href="/app_manage/api/public/themes/admin_simpleboot3/public/assets/themes/<?php echo cmf_get_admin_style(); ?>/bootstrap.min.css" rel="stylesheet">
    <link href="/app_manage/api/public/themes/admin_simpleboot3/public/assets/simpleboot3/css/simplebootadmin.css" rel="stylesheet">
    <link href="/app_manage/api/public/static/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <!--[if lt IE 9]>
    ...
    <script type="text/javascript">
        //全局变量
        var GV = {
            ROOT: "/app_manage/api/public/",
            WEB_ROOT: "/app_manage/api/public/",
            JS_ROOT: "static/js/",
            APP: '<?php echo \think\Request::instance()->module(); ?>'/*当前应用名*/
        };
    </script>
    <script src="/app_manage/api/public/themes/admin_simpleboot3/public/assets/js/jquery-1.10.2.min.js"></script>
    <script src="/app_manage/api/public/static/js/wind.js"></script>
    <script src="/app_manage/api/public/themes/admin_simpleboot3/public/assets/js/bootstrap.min.js"></script>
    <script>
        Wind.css('artDialog');
        Wind.css('layer');
        $(function () {
    ...
    <form action="<?php echo url('AdminArticle/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_main',$temp5be422d728689,null,false);
 ?>
            ...
            <div class="col-md-3">
                        ...
                        <td>
                            <div style="text-align: center;">
                                ...
                                <a href="javascript:uploadOneImage('图片上传','#thumbnail');">
                                    <img src="/app_manage/api/public/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png"
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_right_sidebar',$temp5be422d7286e7,null,false);
 ?>
            </div>
        </div>
    </form>
</div>
<script type="text/javascript" src="/app_manage/api/public/static/js/admin.js"></script>
<script type="text/javascript">
    //编辑器路径定义
    var editorURL = GV.WEB_ROOT;
</script>
<script type="text/javascript" src="/app_manage/api/public/static/js/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="/app_manage/api/public/static/js/ueditor/ueditor.all.min.js"></script>
<script type="text/javascript">
    $(function () {
        ...
        $('.btn-cancel-thumbnail').click(function () {
            $('#thumbnail-preview').attr('src', '/app_manage/api/public/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png');
            $('#thumbnail').val('');
        });
