...
<div class="wrap">
    ...
    <script src="/app_manage/api/public/static/js/validate.js"></script>
    <script src="/app_manage/api/public/static/js/ajaxForm.js"></script>
    <script>
        function TestDbPwd() {
